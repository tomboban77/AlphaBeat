        ...
        <nav className="mx-auto flex max-w-7xl items-center gap-3 px-4 py-3 sm:px-6 lg:px-8">
          ...
          <div className="ml-auto flex items-center gap-2">
            ...
            >
              ...
              <span className="hidden md:inline">Search tickers…</span>
            ...
            <Link
              href="/watchlist"
              className={cn(
                "relative inline-flex h-9 items-center justify-center gap-1.5 rounded-md border px-2.5 text-sm font-medium transition-colors sm:px-3 md:hidden",
                watchlist.length > 0
