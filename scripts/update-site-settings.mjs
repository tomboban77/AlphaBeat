...
await sanity.patch(doc._id).set({
  tagline: "Canadian investing, made clearer.",
  marketTickerSymbols: [
    "^GSPTSE",
    "^GSPC",
    "RY.TO",
...
console.log("   Tagline: Canadian investing, made clearer.");
console.log("   Marquee: ^GSPTSE, ^GSPC, RY.TO, ENB.TO, SHOP.TO, CNQ.TO, TD.TO, AEM.TO, FTS.TO, WCN.TO");
