# AlphaBeat Issue #1 — The Top 10 for the Week of May 4, 2026

> **How to use this file:** This is your draft for the first Beehiiv post.
> Open Beehiiv → **Posts → + New Post**. Title and subtitle below. Paste the
> body section into the editor. Beehiiv's editor will auto-format markdown
> headings, lists, and bold. Set the post tags to `Top 10`, `Weekly`, and
> `Stocks`. Hit **Publish & Send**.

---

## Title (paste into the title field)

The Top 10 for the week of May 4

## Subtitle (paste into the subtitle field)

Mega-cap tech is back in the saddle. Banks and energy tape look constructive. Here's where the editor is leaning this week.

---

## BODY — paste everything below this line into the Beehiiv editor

Welcome to the first issue of AlphaBeat.

Every Sunday I'll send you the same thing: ten stocks worth your attention this week, ranked by conviction. Each pick comes with a thesis, a time horizon, and what could go wrong. No filler, no affiliate links, no "5 stocks to BUY NOW" garbage.
...
Mega-cap tech earnings landed mostly ahead and capex commitments stayed elevated, putting a bid back under the AI complex. Bank prints showed normalizing credit but solid net interest income. The energy tape held its post-OPEC bounce.

The list this week leans into tickers where **business momentum and price action both line up.**
...
- **CPI print Wednesday.** Anything north of consensus puts pressure on the rate-cut narrative banks are riding into Q3.
- **NVDA earnings cycle approaching.** Whisper numbers always run hot into the print. Don't chase the day before.
- **Loonie stress.** USD/CAD has been quietly grinding higher. If you hold US names in CAD accounts, that tailwind has helped — be aware it could mean-revert.

---

## One last thing

Every pick on this list has a full editorial deep-dive on the site — bull case, bear case, catalysts, risk score. Click any ticker symbol if you want the long version.

If a friend forwarded this to you, [subscribe here](https://alphabeat.io/) so you don't miss next Sunday.
